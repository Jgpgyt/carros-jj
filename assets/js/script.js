...
function setSlider() {
    ...
    if (active === 0) {
        ...
        container.style.backgroundImage = 'radial-gradient(circle, #FFFFFF, #000)';
        activeDescription.style.color = cor5;
        activeCarInfo.style.color = cor5;
        activeH2.style.color = cor5;
        activeLi.style.backgroundColor = cor5;
    }
